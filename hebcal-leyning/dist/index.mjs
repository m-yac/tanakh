...
import { parshiot, flags, months, Event, HebrewCalendar, HDate } from '@hebcal/core';
...
function getLeyningKeyForEvent(e, il = false) {
  ...
  if (isShabbat) {
    if (isRoshChodesh) {
      if (day === 30 && month === months.KISLEV || day === 1 && month === months.TEVET) {
        return 'Shabbat Rosh Chodesh Chanukah';
      }
...
export { Triennial, addSefariaLinksToLeyning, calculateHaftarahNumVerses, calculateNumVerses, formatAliyahShort, formatAliyahWithBook, getLeyningForHoliday, getLeyningForHolidayKey, getLeyningForParsha, getLeyningForParshaHaShavua, getLeyningKeyForEvent, getTriennial, getTriennialForParshaHaShavua, festivals as holidayReadings, makeLeyningParts, makeLeyningSummary, makeSummaryFromParts, parshaToString, parshiyotObj as parshiyot, specialReadings, writeFullKriyahCsv, writeTriennialCsv };
